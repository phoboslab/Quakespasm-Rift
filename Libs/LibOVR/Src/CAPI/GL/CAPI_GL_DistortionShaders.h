...
namespace OVR { namespace CAPI { namespace GL {
    ...
    "void main()\n"
    "{\n"
#ifdef BLACK_GHOSTING_FIX
    "   _FRAGCOLOR = max(_TEXTURELOD(Texture0, oTexCoord0, 0.0),8.0/255.0);\n"
#else
...
#ifdef BLACK_GHOSTING_FIX
    "   _FRAGCOLOR = max(vec4(ResultR * oColor.r, ResultG * oColor.g, ResultB * oColor.b, 1.0), 8.0/255.0);\n"
#else
